...
<div data-aos="fade-up">
    ...
    <form method="POST">
        <input type="email" name="email" placeholder="Email adresa" required style="padding: 15px; width:300px; font-size: large; color:black; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;"> <br><br>
